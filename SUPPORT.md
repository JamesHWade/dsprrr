...
Thanks for using dsprrr! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/JamesHWade/dsprrr/issues/new).
...
requests](https://github.com/JamesHWade/dsprrr/issues) to make sure the
