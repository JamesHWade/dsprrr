...
LLM generation to produce grounded, factual responses. dsprrr provides
native integration with ragnar, the tidyverse RAG package.
...
1.  **[`rag_module()`](https://jameshwade.github.io/dsprrr/reference/rag_module.md)**:
    Create modules that auto-retrieve context
2.  **[`ragnar_tool()`](https://jameshwade.github.io/dsprrr/reference/ragnar_tool.md)**:
    Create search tools for agents
3.  **[`create_search_tool()`](https://jameshwade.github.io/dsprrr/reference/create_search_tool.md)**:
    Quick tool creation from documents
