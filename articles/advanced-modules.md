...
reasoning** with MultiChainComparison
...
1.  **[`chain_of_thought()`](https://jameshwade.github.io/dsprrr/reference/chain_of_thought.md)** -
    Force step-by-step reasoning
2.  **[`best_of_n()`](https://jameshwade.github.io/dsprrr/reference/best_of_n.md)** -
    Multiple attempts with scoring
3.  **[`refine()`](https://jameshwade.github.io/dsprrr/reference/refine.md)** -
    Iterative improvement with feedback
4.  **[`multi_chain_comparison()`](https://jameshwade.github.io/dsprrr/reference/multi_chain_comparison.md)** -
    Ensemble synthesis

Start with ChainOfThought for complex tasks, add BestOfN for
reliability, and graduate to Refine or MCC when you need maximum
quality.
