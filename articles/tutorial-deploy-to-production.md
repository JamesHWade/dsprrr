...
#> Creating new version '20260104T193010Z-56242'
...
#>  $ file_size  : 'fs_bytes' int 596
#>  $ pin_hash   : chr "56242dcf38618e4e"
#>  $ type       : chr "rds"
#>  $ title      : chr "sentiment-classifier: a pinned list"
#>  $ description: chr "dsprrr module config: sentiment-classifier"
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-01-04 19:30:10"
#>  $ api_version: int 1
#>  $ user       : list()
#>  $ name       : chr "sentiment-classifier"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmptQiFgN/sentiment-classifier/20260104T193010Z-56242"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260104T193010Z-56242"
```
...
#> Creating new version '20260104T193011Z-c1b5a'
#> Writing to pin 'sentiment-classifier'
#> ✔ Pinned module configuration: "sentiment-classifier"
#> ℹ Module type: <PredictModule>
#> ℹ Compiled: TRUE
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260104T193010Z-56242 2026-01-04 19:30:10 56242
#> 2 20260104T193011Z-c1b5a 2026-01-04 19:30:11 c1b5a
```
