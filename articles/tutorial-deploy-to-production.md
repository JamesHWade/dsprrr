...
#> Creating new version '20260207T005516Z-fd998'
...
#>  $ pin_hash   : chr "fd998d9f82ecd75e"
#>  $ type       : chr "rds"
#>  $ title      : chr "sentiment-classifier: a pinned list"
#>  $ description: chr "dsprrr module config: sentiment-classifier"
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-02-07 00:55:16"
#>  $ api_version: int 1
#>  $ user       : list()
#>  $ name       : chr "sentiment-classifier"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmpVsPyde/sentiment-classifier/20260207T005516Z-fd998"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260207T005516Z-fd998"
```
...
#> Creating new version '20260207T005517Z-1ae34'
#> Writing to pin 'sentiment-classifier'
#> ✔ Pinned module configuration: "sentiment-classifier"
#> ℹ Module type: <PredictModule>
#> ℹ Compiled: TRUE
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260207T005516Z-fd998 2026-02-07 00:55:16 fd998
#> 2 20260207T005517Z-1ae34 2026-02-07 00:55:17 1ae34
```
