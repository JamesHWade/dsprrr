...
#> Creating new version '20260104T182723Z-0f2a7'
...
#>  $ file_size  : 'fs_bytes' int 594
#>  $ pin_hash   : chr "0f2a7927b27dc146"
#>  $ type       : chr "rds"
#>  $ title      : chr "sentiment-classifier: a pinned list"
#>  $ description: chr "dsprrr module config: sentiment-classifier"
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-01-04 18:27:23"
#>  $ api_version: int 1
#>  $ user       : list()
#>  $ name       : chr "sentiment-classifier"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmpyzhLFn/sentiment-classifier/20260104T182723Z-0f2a7"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260104T182723Z-0f2a7"
```
...
#> Creating new version '20260104T182723Z-6db5d'
#> Writing to pin 'sentiment-classifier'
#> ✔ Pinned module configuration: "sentiment-classifier"
#> ℹ Module type: <PredictModule>
#> ℹ Compiled: TRUE
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260104T182723Z-0f2a7 2026-01-04 18:27:23 0f2a7
#> 2 20260104T182723Z-6db5d 2026-01-04 18:27:23 6db5d
```
