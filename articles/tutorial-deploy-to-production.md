...
#> Creating new version '20260127T025938Z-ee4b4'
...
#>  $ pin_hash   : chr "ee4b4864acefee00"
#>  $ type       : chr "rds"
#>  $ title      : chr "sentiment-classifier: a pinned list"
#>  $ description: chr "dsprrr module config: sentiment-classifier"
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-01-27 02:59:38"
#>  $ api_version: int 1
#>  $ user       : list()
#>  $ name       : chr "sentiment-classifier"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmpYHpMpc/sentiment-classifier/20260127T025938Z-ee4b4"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260127T025938Z-ee4b4"
```
...
#> Creating new version '20260127T025938Z-37289'
#> Writing to pin 'sentiment-classifier'
#> ✔ Pinned module configuration: "sentiment-classifier"
#> ℹ Module type: <PredictModule>
#> ℹ Compiled: TRUE
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260127T025938Z-37289 2026-01-27 02:59:38 37289
#> 2 20260127T025938Z-ee4b4 2026-01-27 02:59:38 ee4b4
```
