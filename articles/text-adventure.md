...
We’ll start with the simplest approach—plain lists—then show how S7 adds
...
Both work with dsprrr. The AI signatures and modules are the same—only
the state management differs.
