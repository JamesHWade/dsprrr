---
title: "Vitals Integration Recipes"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Vitals Integration Recipes}
...
# Compare performance
cat("Test accuracy:", mean(eval_task$scores$score == "C"), "\n")
```
...
Best for checking specific patterns in output:

```{r scorer-pattern}
#| cassette: scorer-pattern
...
for (name in c("basic", "cot")) {
  ...
  results[[name]] <- mean(task$scores$score == "C")
}
