# Contributing to dsprrr

This outlines how to propose a change to dsprrr. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("JamesHWade/dsprrr", fork = TRUE)`.
...
Please note that the dsprrr project is released with a [Contributor Code
of Conduct](https://jameshwade.github.io/dsprrr/CODE_OF_CONDUCT.md). By
